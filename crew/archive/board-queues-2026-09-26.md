# Board queues and orders, archived 2026-09-26

Jerry cleared the board of the previous work when the scenes mission started (D-41). This is every finished
or parked task and every older order from Jerry, word for word, so nothing is lost. Nothing here is active;
the decisions (D-1 to D-41) stay on the board because they still stand.

## Finished and parked tasks

### Parked when the board was cleared (showcase-era, not finished)

Grokbot checked in on GB-58 at 2026-09-25T21:20Z and its last note was 22:05Z (a line-check fix: shotBlocked
counts builds and world solids, t80 13/0). Both parked, not dropped: bring them back if the night-12 spider or the
48-zombie frame comes up again.
